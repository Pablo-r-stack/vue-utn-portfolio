...
const educacion = ref([
  {fecha: '2025', title: 'Técnicatura Universitaria en Programacion', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'https://www.frsr.utn.edu.ar/'},
  {fecha: '2024', title: 'Bootcamp Programación Web Full Stack', descripcion: 'Complete un bootcamp intensivo de 6 meses sobre programación web full stack, basado en el stack de NodeJs, tecnologías javascript, typescript, react, expressJs y bases de datos relacionales.', enlace:'https://www.linkedin.com/in/pablo-r-velasco/details/certifications/1724970897004/single-media-viewer/?profileId=ACoAADVkECEBcXofyIXnJkyXPJupKQW76UmwwQU'},
  {fecha: '2024', title: 'Curso Programador Web Front end', descripcion: 'Realicé un curso intensivo de programación web front end, en el marco del programa de formación Oracle Next Education organizado por Oracle y Alura Latam.', enlace:'https://app.aluracursos.com/degree/certificate/f29667ed-191e-4fdf-9e25-bdd3dca8d315'},
  {fecha: '2023', title: 'Bootcamp Programación Web Full Stack', descripcion: 'Completé un bootcamp intensivo de 1 año en programación web, aprendiendo basado en tecnologías como Java, Spring, MySql, HTML, CSS, JavaScript, React, Node.js', enlace:'https://egg-csv-bulk-certificates-prod.s3.amazonaws.com/certificates/65401608970c8dce2d2f8d14-1702910614594.pdf'},
  {fecha: '2022', title: 'Curso programación web desde 0', descripcion: 'Completé un curso sobre introducción a los fundamentos de programación, paradigmas y tecnologías web.', enlace:'https://drive.google.com/file/d/17FpgMn1lK6QJdsbK0AVBhnVkn3Mu6TcL/view'}
]);
</script>
