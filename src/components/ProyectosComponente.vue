<script setup>
import proyecto1 from '/src/assets/img/projects/rentary-project.png';
import proyecto2 from '/src/assets/img/projects/alma-project.png';
import proyecto3 from '/src/assets/img/projects/pasos-project.png';
import proyecto4 from '/src/assets/img/projects/sonica-project.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Aplicación de gestión inmobiliaria (2025)",
        descripcion: "Desarrollé una aplicación web con React en el marco de un proyecto grupal, Typescript y Tailwind Css. La misma permite a los usuarios registrarse, iniciar sesión y gestionar sus propiedades inmobiliarias. Además, ofrece una interfaz intuitiva para buscar y reservar propiedades.",
        projectoLink: "https://foo-talent.vercel.app/",
        githubLink: "https://github.com/FooTalentGroup/Rentary"
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Landing Page para emprendimiento turistico (2025)",
        descripcion: "Diseñe y desarrollé una landing page en formato SPA utilizando React, Typescript y Tailwind Css. El mismo corresponde a un cliente particular que necesitaba visualizar su emprendimiento turistico, en este caso un camping/parador.",
        projectoLink: "https://alma-page.vercel.app/",
        githubLink: "https://github.com/Pablo-r-stack/AlmaPage"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Aplicación Banco de ortesis (2024)",
        descripcion: "Desarrollé una aplicación web con React, Typescript y Tailwind Css. En el marco de un proyecto grupal, la cual permite a los usuarios buscar y reservar ortesas disponibles en un banco ortésico, buscando plantear una solución basada en una red comunitaria de colaboración.",
        projectoLink: "https://pasos-deploy-front.vercel.app/login",
        githubLink: "https://github.com/No-Country-simulation/s16-06-m-java-react"
    },
    {
        id: 4,
        src: proyecto4,
        titulo: "Aplicación de Reservas de tickets de eventos (2024)",
        descripcion: "Diseñé y desarrollé una aplicación web con VanillaJs, html, css y express. La misma trata de una plataforma web para visualizar y reservar tickets de eventos, ofreciendo una experiencia intuitiva y segura para los usuarios.",
        projectoLink: "https://pasos-deploy-front.vercel.app/login",
        githubLink: "https://github.com/No-Country-simulation/s16-06-m-java-react"
    },
])
...
.proyecto {
    ...
    width: 100%;
    /* Espacio interno entre imagen y contenido */
    gap: 20px;
...
.proyecto img {
    /* Imagen más pequeña en disposición horizontal */
    flex: 0 0 30%;
    max-width: 30%;
    height: auto;
    display: block;
...
.proyecto-info {
    ...
    text-align: center;
    /* Distribuye el contenido en columna para empujar los enlaces al fondo */
    display: flex;
    flex-direction: column;
}
